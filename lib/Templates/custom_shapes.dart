...
class CustomShapeClipper3 extends CustomClipper<Path> {
  ...
  Path getClip(Size size){
    ...
    var firstControlPoint = Offset(size.width * 0.5, size.height/1.25);
    path.quadraticBezierTo(firstControlPoint.dx, firstControlPoint.dy, firstEndPoint.dx, firstEndPoint.dy);
...
class CustomShapeClipper4 extends CustomClipper<Path> {
  ...
  Path getClip(Size size){
    ...
    var firstEndPoint = Offset(size.width, size.height / 1.65);
    var firstControlPoint = Offset(size.width * 0.5, size.height/1.65);
    path.quadraticBezierTo(firstControlPoint.dx, firstControlPoint.dy, firstEndPoint.dx, firstEndPoint.dy);
